...
public class RoundAngleFrameLayout extends FrameLayout {
    ...
    private float topLeftRadius = 50;
    private float topRightRadius = 50;
    private float bottomLeftRadius = 50;
    private float bottomRightRadius = 50;
...
//        canvas.saveLayerAlpha(new RectF(0, 0, canvas.getWidth(), canvas.getHeight()), 255, Canvas.ALL_SAVE_FLAG);
//        canvas.save(); // 裁剪的角度会变成黑色
